/** \file: defines.h --- Global constants and macro definitions
 *
 *
 ...
 * save file mis-reads.  Most of the comments in this file are meant as
 ...
 * Note that "INVEN_PACK" is probably hard-coded by its use in save files, and
...
/**
 * Indexes of the various "stats" (hard-coded by save files, etc).
 */
#define A_STR   0
#define A_INT   1
#define A_WIS   2
...
/** Race flags */
#define PR1_EXPERIMENTAL        0x00000001L     /**< Is still under development */
/** XXX */
...
#define PR1_NO_SUBRACE_CHANGE   0x00040000L     /**< Impossible to change sub-race */
/** XXX */
#define PR1_ANTIMAGIC           0x00100000L     /**< anti-magic ... hack */
 ...
 */
#define USE_EQUIP    0x01	/**< Allow equipped items */
#define USE_INVEN    0x02	/**< Allow inventory items */
...
#define IDENT_STOREB            0x10    /**< Item is store-bought !!!! */
...
#define TR1_MANA                        0x00000040L     /**< Mana multiplier */
...
#define TR4_EASY_USE            0x00200000L     /**< Easily activated */
...
#define TR5_MAGIC_BREATH        0x00004000L     /**< Can breath anywhere */
#define TR5_WATER_BREATH        0x00008000L     /**< Can breath underwater */
#define TR5_WIELD_CAST          0x00010000L     /**< Need to be wielded to cast spells from it (if it can be wielded) */
...
#define DF1_SMALL               0x00000008L	/**< Creates small levels like Dol Goldur */
#define DF1_BIG                 0x00000010L	/**< Creates big levels like Moria, and Angband dungeons */
#define DF1_NO_DOORS            0x00000020L	/**< No doors on rooms, like Barrow Downs, Old Forest etc) */
...
#define DF2_WATER_BREATH        0x00000800L     /**< Oops, cannot breath here, need water breathing */
...
#define RF2_SHAPECHANGER        0x00000400      /**< TY: shape-changer */
...
#define RF9_NEVER_GENE          0x00004000      /**< The monster cannot be normally generated */
 ...
 * NO MORE USED but for save file compatibility
 */
...
#define TOWN_DUNGEON    4               /**< Maximum number of towns per dungeon */
 ...
 * modified will also result in an invalid value -- TODO: Improve loadsave?
 */
#define LS_LOAD 3
#define LS_SAVE 7
 ...
 * Skills !
 */
#define SKILL_MAX               50000      /**< Maximum skill value */
...
#define SKF1_AUTO_HIDE          0x00000002      /**< Tries to hide again at calc_bonus */
